 ...
 */
const Link$1 = /*#__PURE__*/React.forwardRef(function LinkWithRef(_ref7, ref) {
  let {
      onClick,
      relative,
      reloadDocument,
...
const Label = ({ htmlFor, children, required = false, className = "" }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor, className: clsx("flex flex-col gap-1", className), children: React__default.Children.map(
    children,
...
export { Azure, ChangePassword, ColorChange, Home as Contact, Button as DefaultButton, Footer, Header, Home$1 as Home, Icon, Image, InputCheckbox, InputDate, InputEmail, InputFile, Label, Link, Login, Logo, MainLayout, PopUp, Redirect, ResetPassword, ScrollToTopButton, Snackbar as SnackBar, Title, UserMenu, fileUtils, useLocalStorage };
