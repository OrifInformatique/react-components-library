 ...
 */
const Link$1 = /*#__PURE__*/React__namespace.forwardRef(function LinkWithRef(_ref7, ref) {
  let {
      onClick,
      relative,
      reloadDocument,
...
const NavLink = /*#__PURE__*/React__namespace.forwardRef(function NavLinkWithRef(_ref8, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(Link$1, _extends({}, rest, {
...
const Image = ({
  ...
  const [insertImagePlaceholder, setInsertImagePlaceholder] = React.useState(false);
  React.useEffect(() => {
    if (src)
...
const Label = ({ htmlFor, children, required = false, className = "" }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor, className: clsx("flex flex-col gap-1", className), children: React.Children.map(
    children,
...
const InputText = ({
  ...
  var _a;
  const [internalValue, setInternalValue] = React.useState((_a = value != null ? value : defaultValue) != null ? _a : "");
...
const Login = () => {
  const [showLocalAccountLoginForm, setShowLocalAccountLoginForm] = React.useState(false);
...
const ColorChange = ({
  ...
  const [colorValue, setColorValue] = React.useState(defaultColor);
  const [hexInputValue, setHexInputValue] = React.useState(defaultColor.replace("#", ""));
